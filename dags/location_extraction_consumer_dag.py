...
# CONSUMER_SCRIPT = os.path.join(SCRIPTS_PATH, "run_consumer.sh")
...
# with DAG(
#     'location_extraction_consumer_dag',
#     default_args=default_args,
#     description='Run Location Extraction Kafka Consumer (Raw Python)',
#     schedule_interval=timedelta(minutes=30),
#     start_date=datetime(2024, 1, 1),
#     catchup=False,
#     tags=['location_extraction', 'consumer', 'kafka'],
# ) as dag:
...
#         bash_command=f"bash {CONSUMER_SCRIPT} ",
#         env=consumer_env,
#     )
