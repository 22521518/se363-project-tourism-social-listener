...
const ALL_TABS: TabType[] = ['summary', 'asca', 'intention', 'location_extraction', 'traveling_type'];
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="flex flex-wrap border-b border-gray-200">
        {ALL_TABS.map((tab) => {
          ...
          const label = tab === 'summary' ? 'Summary' : TASK_LABELS[tab as ProcessingTask];
          const color = tab === 'summary' ? '#6366f1' : TASK_COLORS[tab as ProcessingTask];
          const count = tab !== 'summary' && processedCounts 
