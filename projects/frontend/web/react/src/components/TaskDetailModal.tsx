      ...
      try {
        ...
        setDetails({
          ...
          location_extraction: {
            ...
            locations: (response.location_extraction?.locations || []).map(
              (l) => ({
                name: l.word,
                type: l.entity_group,
                score: l.score,
        ...
        <div className="flex-1 p-6 overflow-y-auto">
            ...
            <div className="flex flex-wrap gap-2 mt-2 text-xs text-gray-500">
              {isYouTube ? (
                <>
                  <span>
                    👤{" "}
                    {(metadata as YouTubeCommentMetadata).author_name ||
                      "Anonymous"}
                  </span>
                  <span>
          ...
          {!loading && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              >
                {details?.location_extraction.locations &&
                details.location_extraction.locations.length > 0 ? (
