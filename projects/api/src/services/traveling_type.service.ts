...
export class TravelingTypeService {
  ...
  async getTravelingTypeStats(): Promise<TravelingTypeStats[]> {
    const travelingTypes = await travelingTypeRepository.findAll();
  ...
  async getVideoTravelingTypeStats(id: string): Promise<TravelingTypeStats[]> {
    const travelingTypes = await travelingTypeRepository.findByVideo(id);
