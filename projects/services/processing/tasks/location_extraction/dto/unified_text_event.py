...
This is the canonical input format for the location extraction pipeline.
...
class UnifiedTextEvent(BaseModel):
    """
    Canonical input DTO for location extraction.
    ...
    text: str = Field(
        ...,
        description="Raw text content to extract locations from"
    )
